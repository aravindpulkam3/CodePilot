import type { EmbeddingClient, SummaryJSON } from "../../infrastructure/summarization/summaryTypes.js";
...
export function buildEmbeddingText(summary: SummaryJSON): string {
  ...
  switch (nodeType) {
    case "file": {
      const s = summary as import("../../infrastructure/summarization/summaryTypes.js").FileSummary;
      return [
        s.purpose,
        s.summary,
    ...
    case "component": {
      const s = summary as import("../../infrastructure/summarization/summaryTypes.js").ComponentSummary;
      return [
        s.purpose,
        s.summary,
        s.responsibilities?.join(". "),
    ...
    case "architecture": {
      const s = summary as import("../../infrastructure/summarization/summaryTypes.js").ArchitectureSummary;
      return [
        s.summary,
        s.architectureStyle,
        s.majorLayers?.join(", "),
    ...
    case "repository": {
      const s = summary as import("../../infrastructure/summarization/summaryTypes.js").RepositorySummary;
      return [
        s.purpose,
        s.summary,
        s.features?.join(". "),
